...
# The BatchGrabber inherits from the sequence class which is used to generate
...
class BatchGrabber(tf.keras.utils.Sequence):
...
class TextClassificationBatchGrabber(BatchGrabber):
    
    def __init__(self, x_set, y_set, batch_size, classifier, shuffle_data=True):
        BatchGrabber.__init__(self, x_set, y_set, batch_size, classifier, shuffle_data=shuffle_data)
...
class TokenClassifierBatchGrabber(BatchGrabber):
    def __init__(self, x_set, y_set, batch_size, classifier, shuffle_data=True):
        BatchGrabber.__init__(self, x_set, y_set, batch_size, classifier, shuffle_data=shuffle_data)
