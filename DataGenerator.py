...
class DataGenerator(tf.keras.utils.Sequence):
    ...
    def __init__(self, x_set, y_set, batch_size, tokenizer, shuffle=True, max_length=MAX_LENGTH):
        self.x = x_set
        self.y = y_set
    ...
    def __getitem__(self, idx):
        ...
        #Tokenize the input
        tokenized = self.tokenizer(batch_x, padding=True, truncation=True, max_length=self._max_length, return_tensors='tf')
